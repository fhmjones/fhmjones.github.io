...
* **MaunaLoaCO2** Currently installed for use [here](https://hub.envr300.portal.eoas.ubc.ca/services/external/envr-300/monaloa/), although this is likely to change. 
...
* **Three Signals** Currently installed for use [here](https://hub.envr300.portal.eoas.ubc.ca/services/external/envr-300/three-signals/), although this is likely to change.
...
* **Vancouver-Ozone** Currently installed for use [here](https://hub.envr300.portal.eoas.ubc.ca/services/external/envr-300/ozone/), although this is likely to change.
  * Goals:
...
* **Oceanography** not yet installed for use
...
* **Interactive sketching app**: not yet installed.
